...
export function getMockCompetitors(city) {
  const competitors = {
    Marken: [
      { id: 1, name: 'Volendam Beach Hotel', dist: '3.2 km' },
      { id: 2, name: 'Waterland Suites', dist: '5.1 km' },
      { id: 3, name: 'IJsselmeer Grand', dist: '8.0 km' },
      { id: 4, name: 'Het Houten Huis', dist: '1.5 km' },
      { id: 5, name: 'Pension de Haven', dist: '0.8 km' },
    ],
    Paris: [
      { id: 1, name: 'Hotel Le Marais', dist: '0.3 km' },
      { id: 2, name: 'Boutique Saint-Germain', dist: '0.5 km' },
      { id: 3, name: 'Le Petit Cler', dist: '0.8 km' },
      { id: 4, name: 'Hotel des Arts', dist: '1.1 km' },
      { id: 5, name: 'Maison Montmartre', dist: '2.0 km' },
    ],
    Milan: [
      { id: 1, name: 'Palazzo Duomo', dist: '0.2 km' },
      { id: 2, name: 'Hotel Navigli', dist: '0.6 km' },
      { id: 3, name: 'Boutique Brera', dist: '0.4 km' },
      { id: 4, name: 'Residenza Garibaldi', dist: '0.9 km' },
      { id: 5, name: 'Milano Central Inn', dist: '1.3 km' },
    ],
    default: [
      { id: 1, name: 'City Center Hotel', dist: '0.3 km' },
      { id: 2, name: 'The Grand Boutique', dist: '0.5 km' },
      { id: 3, name: 'Harbour View Inn', dist: '0.8 km' },
      { id: 4, name: 'Old Town Pension', dist: '1.1 km' },
      { id: 5, name: 'Riverside Lodge', dist: '1.5 km' },
    ],
  }
